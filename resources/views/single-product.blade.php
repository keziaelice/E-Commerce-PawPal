                ...
                <div class="new-product-wrapper swiper-wrapper">
                        ...
                        <div class="product">
                            <div class="thumb">
                                <a href="single-product" class="image">
                                    <img src="{{asset('images/product-image/8.jpg')}}" alt="Product" />
                                    <img class="hover-image" src="{{asset('images/product-image/6.jpg')}}"
                                        alt="Product" />
                                </a>
                                <span class="badges">
                                ...
                                <div class="actions">
                                    ...
                                    <a href="compare" class="action compare" title="Compare"><i
                    ...
                    <div class="new-product-item swiper-slide">
                        ...
                        <div class="product">
                            <div class="thumb">
                                <a href="single-product" class="image">
                                    <img src="{{asset('images/product-image/9.jpg')}}" alt="Product" />
                                    <img class="hover-image" src="{{asset('images/product-image/5.jpg')}}"
                                        alt="Product" />
                                </a>
                                <span class="badges">
                    ...
                    <div class="new-product-item swiper-slide">
                        ...
                        <div class="product">
                            <div class="thumb">
                                <a href="single-product" class="image">
                                    <img src="{{asset('images/product-image/10.jpg')}}" alt="Product" />
                            ...
                            <div class="content">
                                ...
                                <h5 class="title"><a href="single-product">Women's Long
                                        Sleeve
                                        Shirts</a></h5>
                                <span class="price">
                    ...
                    <div class="new-product-item swiper-slide">
                        ...
                        <div class="product">
                            <div class="thumb">
                                <a href="single-product" class="image">
                                    <img src="{{asset('images/product-image/11.jpg')}}" alt="Product" />
                                    <img class="hover-image" src="{{asset('images/product-image/11.jpg')}}"
                                        alt="Product" />
                                </a>
                                <span class="badges">
                            ...
                            <div class="content">
                                ...
                                <h5 class="title"><a href="single-product">Parrera
                                        Sunglasses -
                                        Lomashop</a></h5>
                                <span class="price">
                                    <span class="new">$38.50</span>
