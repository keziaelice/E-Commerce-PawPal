...
<body>
    ...
    <!-- checkout area start -->
    <div class="checkout-area pt-5 pb-100px">
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                ...
                <div class="col-lg-5 mt-md-30px mt-lm-30px ">
                    <div class="your-order-area">
                        ...
                        <div class="your-order-wrap gray-bg-4">
                            <div class="your-order-product-info">
                                ...
                                <div class="your-order-middle">
                                    <ul>
                                        <li><span class="order-middle-left">Royal Canin Golden Retriever Adult</span> <span
                                                class="order-price">Rp1.179.000 </span></li>
                                        <li><span class="order-middle-left">Me-O Creamy Treats Salmon</span> <span
                                                class="order-price">Rp21.900 </span></li>
                                        <li><span class="order-middle-left">Non-Toxic Rubber Chew Bone Toy</span> <span
                                                class="order-price">Rp32.000 </span></li>
                                    </ul>
                                </div>
                        ...
                        <div class="Place-order mt-25">
                            <a class="btn-hover" href="my-account">Place Order</a>
                        </div>
                    </div>
                </div>
            </div>
