                                ...
                                <tbody>
                                    <tr>
                                        <td class="product-thumbnail">
                                            <a href="product-detail"><img class="img-responsive ml-15px"
                                                    src="{{asset('storage/p0003.jpeg')}}" alt="" /></a>
                                        </td>
                                        <td class="product-name"><a href="#">Royal Canin Golden Retriever Adult</a></td>
                                        <td class="product-price-cart"><span class="amount">Rp1.179.000</span></td>
                                        ...
                                        <td class="product-subtotal">Rp1.179.000</td>
                                    ...
                                    <tr>
                                        <td class="product-thumbnail">
                                            <a href="product-detail"><img class="img-responsive ml-15px"
                                                    src="{{asset('storage/p0012.png')}}" alt="" /></a>
                                        </td>
                                        <td class="product-name"><a href="#">Me-O Creamy Treats Salmon</a></td>
                                        <td class="product-price-cart"><span class="amount">Rp21.900</span></td>
                                        <td class="product-quantity">
                                            <div class="cart-plus-minus">
                                                <input class="cart-plus-minus-box" type="text" name="qtybutton"
                                                    value="1" />
                                        ...
                                        <td class="product-subtotal">Rp21.900</td>
                                        <td class="product-remove">
                                            <a href="#"><i class="fa fa-pencil"></i></a>
                                            <a href="#"><i class="fa fa-times"></i></a>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="product-thumbnail">
                                            <a href="product-detail"><img class="img-responsive ml-15px"
                                                    src="{{asset('storage/p0007.jpg')}}" alt="" /></a>
                                        </td>
                                        <td class="product-name"><a href="#">Non-Toxic Rubber Chew Bone Toy</a></td>
                                        <td class="product-price-cart"><span class="amount">Rp32.000</span></td>
                                        <td class="product-quantity">
                                            <div class="cart-plus-minus">
                                                <input class="cart-plus-minus-box" type="text" name="qtybutton"
                                                    value="1" />
                                        ...
                                        <td class="product-subtotal">Rp32.000</td>
                                        <td class="product-remove">
                                            <a href="#"><i class="fa fa-pencil"></i></a>
                                            <a href="#"><i class="fa fa-times"></i></a>
                                        </td>
                            ...
                            <div class="col-lg-12">
                                <div class="cart-shiping-update-wrapper">
                                    ...
                                    <div class="cart-clear">
                                        <a href="cart"><button>Update Shopping Cart</button></a>
                                        <a href="cart">Clear Shopping Cart</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 mt-md-30px">
                            <div class="grand-totall">
                                ...
                                <h5>Total products <span>Rp1.232.900</span></h5>
                                <div class="total-shipping">
                                    <h5>Total shipping</h5>
                                    <ul>
                                        <li><input type="radio" name="shipping"/> Standard <span>Rp30.000</span></li>
                                        <li><input type="radio" name="shipping" /> Express <span>Rp50.000</span></li>
                                    </ul>
                                </div>
                                <h4 class="grand-totall-title">Grand Total <span>Rp1.262.900</span></h4>
